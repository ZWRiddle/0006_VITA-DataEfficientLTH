...
echo "train_testmask.py baseaug to ${timestamp}_${OUT_DIR_PREFIX}_${DATA_SIZE}_${DATA_SIZE_2}_${DATASET}_baseaug"
python3 "train_testmask.py" --dset ${DATASET} --data_root data/ --data_size $DATA_SIZE --data_size_2 $DATA_SIZE_2 --mode $MODE\
    ...
    --epoch 60 --pruning_iters 5 --lr 0.1 --prune_rate 0.37
